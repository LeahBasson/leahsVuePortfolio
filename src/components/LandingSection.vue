...
<div class="container-fluid"> 
    ...
    <div class="banner">
      <div class="stars">
        <div class="star"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot text-white" viewBox="0 0 16 16">
  ...
  <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"/>
        ...
        <div class="homeImg">
        <img class="img-fluid" src="https://leahbasson.github.io/MyImages/images/leah.png" alt="leah" loading="eager">
        </div>
              
        <div class="Greeting p-5 mt-3">
